...
use crate::{alliases::MicroUsdc, BASE_FEE_BPS, INTERVAL_SECONDS, MAX_RATE_BPS, SENSITIVITY_BPS, SKEW_FEE_MAX_BPS};
...
impl Default for FeeSchedule {
    fn default() -> Self {
        FeeSchedule { base_fee_bps: BASE_FEE_BPS, skew_fee_max_bps: SKEW_FEE_MAX_BPS }
    }
}
...
impl Default for FundingConfig {
    fn default() -> Self {
        FundingConfig { sensitivity_bps: SENSITIVITY_BPS, max_rate_bps: MAX_RATE_BPS, interval_seconds: INTERVAL_SECONDS}
    }
}
